        ...
        @if ($featuredProject)
            ...
            <a href="{{ route('projects.show', $featuredProject) }}" class="featured-project" data-animate="fade-up">
                <div class="featured-image-wrap">
                    <img src="{{ asset('images/' . $featuredProject->image) }}"
                        alt="{{ $featuredProject->title }} screenshot" loading="lazy">
                ...
                @if (!$project->featured)
                    <a href="{{ route('projects.show', $project) }}" class="project-card"
                        ...
                        <div class="project-image-wrap">
                            <img src="{{ asset('images/' . $project->image) }}" alt="{{ $project->title }} screenshot"
                                loading="lazy">
